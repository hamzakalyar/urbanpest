...
$heroDesc        = 'Committed to protecting people, Melbourne businesses, and ecological diversity through low-impact IPM, low-toxicity treatments, and humane deterrents.';
$heroTag         = 'ECO COMMITMENT // MELBOURNE DIVISION';
...
<section class="section">
  <div class="container container-narrow">
    ...
    <p style="font-size: var(--text-md); color: var(--color-text-muted); line-height: var(--leading-relaxed);">
      Sustainability isn't an add-on at UrbanPest — it's fundamental to how we operate. We deliver targeted pest management designed to minimise environmental impact while maximising efficacy, utilizing low-hazard formulations and smart monitoring across Greater Melbourne.
    </p>
    ...
    <div style="margin-top: var(--space-2xl); border-radius: var(--radius-xl); overflow: hidden; box-shadow: var(--shadow-xl); border: 1px solid var(--color-border); position: relative;">
      ...
      <div style="position: absolute; bottom: 20px; left: 20px; background: rgba(11,31,58,0.88); backdrop-filter: blur(8px); padding: 10px 20px; border-radius: var(--radius-md); color: #fff; border-left: 3px solid var(--color-emerald); font-size: var(--text-xs);">
        <strong>UrbanPest Melbourne Fleet</strong> • Low-Emission Hybrid Vehicles & Smart Corridor Routing
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid grid-2 grid-gap-xl">
      ...
      $pillars = [
        ...
        ['title' => 'Smart Route Optimisation', 'icon' => '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>', 'desc' => 'Our Melbourne technicians are dispatched via intelligent geographic clustering across CBD, northern, western, and southeastern corridors, cutting travel time and vehicle emissions.'],
