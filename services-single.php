  ...
  <div class="container">
    <div style="background: #FFFFFF; border-radius: 12px; padding: 24px 32px; box-shadow: 0 4px 16px rgba(15, 23, 42, 0.06); border: 1px solid #E2E8F0; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
      <div style="display: flex; align-items: center; gap: 18px;">
        <div style="width: 50px; height: 50px; border-radius: 10px; background: #E8FDF0; border: 1px solid #A7F3D0; display: flex; align-items: center; justify-content: center; color: #0FA968; flex-shrink: 0;">
      ...
      <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
        <a href="tel:<?php echo htmlspecialchars($appConfig['phone_raw'] ?? '+61410148126'); ?>" class="btn btn-secondary" style="padding: 10px 18px; font-size: 0.875rem; font-weight: 600;">
          Call <?php echo htmlspecialchars($appConfig['phone_display'] ?? '+61 410 148 126'); ?>
        </a>
        <a href="<?php echo htmlspecialchars($serviceWhatsAppLink); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-whatsapp" style="padding: 10px 18px; font-size: 0.875rem; font-weight: 600;">
