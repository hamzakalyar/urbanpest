...
$pageDescription = 'Discover UrbanX Connect, our modern digital pest monitoring platform and service tracking across Perth.';
$currentPage = 'about';
...
$heroDesc        = 'Delivering precision pest management through modern tracking, targeted species identification, safe treatment protocols, and digital reporting across Perth.';
...
<section class="section">
  <div class="container">
    <div class="section-header">
      ...
      <h2 class="section-title">UrbanX Digital Tracking</h2>
    ...
    <div style="margin-bottom: var(--space-3xl); border-radius: var(--radius-xl); overflow: hidden; box-shadow: var(--shadow-xl); border: 1px solid var(--color-border); position: relative;">
      ...
      <div style="position: absolute; bottom: 20px; left: 20px; background: rgba(11,31,58,0.88); backdrop-filter: blur(8px); padding: 10px 20px; border-radius: var(--radius-md); color: #fff; border-left: 3px solid var(--color-emerald); font-size: var(--text-xs);">
        <strong>UrbanX™ Operations Console</strong> • Real-Time Western Australian Field Telemetry & Dispatch
      </div>
    </div>
    ...
    <div class="platform-features">
      <?php
      $features = [
        ['title' => 'Real-Time Monitoring', 'icon' => '<path d="M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6"></path><line x1="2" y1="20" x2="2.01" y2="20"></line>', 'desc' => 'Detailed status logs from smart monitoring, preventative bait stations, and inspection checkpoints.'],
